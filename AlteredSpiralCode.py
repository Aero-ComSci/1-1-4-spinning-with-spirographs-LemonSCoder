...
#The distance from one side of the square to another side of the square (smaller distance from one side to another side of the square in comparison to the final code.
concentric_number = 80
#makes sure squares are drawn fifteen times.
while concentric_number <= (1200):
